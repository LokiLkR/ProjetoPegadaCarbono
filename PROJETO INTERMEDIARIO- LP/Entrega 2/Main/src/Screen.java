...
public class Screen extends JFrame {
    ...
    public Screen() {
        ...
        carro = new JTextField("Insira os dados");
        ...
        caminhao = new JTextField("Insira os dados");
    ...
    private void pegadaporhora(ActionEvent actionEvent) {
        ...
        JOptionPane.showMessageDialog(null, "A emissão total foi de "+ Pegada3 + "Kg CO2e");
    }
